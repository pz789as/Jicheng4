...
export default class Line extends Component {
  constructor(props){
    ...
    this.state={
      color: 'green',
      blnShow: props.show == undefined ? true : props.show,
      blnUpdate: false,
    };
  }
  setVisible(bln){
  ...
  render() {
    ...
    if (!this.state.blnShow){//这里处理的就是是否显示线段了，实际是移到屏幕外侧
      x1 = -1;
      y1 = -1;
      x2 = -2;
      y2 = -2;
    ...
    return (
      <Shape d={line} stroke={this.state.color} strokeWidth={1}/>
    );
  }
}
