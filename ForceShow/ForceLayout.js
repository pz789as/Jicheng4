      ...
      for(var i=0;i<this.myEdges.length;i++){
        ...
        if (
          ...
          if (source == target.parent){
            ...
            // for(var k=0;k<this.arrayEdge.length;i++){
            //   if (this.arrayEdge[i] == null) continue; 
            //   if (this.arrayEdge[i].key == this.myEdges[i].order){
            //     this.arrayEdge[i] = null;
            //     break;
            //   }
            // }
            // this.arrayEdge[this.myEdges[i].order] = null;
          }
          count++;
        }
      }
